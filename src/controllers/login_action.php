...
if($email !=null && $password !=null){
    ...
    if($auth){
        ...
        if(isset($remember)){
            //contador para que solo pueda recordar el usuario por un login
            $_SESSION["rememberLoginCounter"]=true;
            $_SESSION["rememberUser"]=$email;
        ...
        setcookie("role", getRole($gdb,$profile["id"]), 0, "/", "localhost");
        //creación de cookie con información del usuario
        setcookie("getUser", getUser($gdb,$email),time()+3600);
